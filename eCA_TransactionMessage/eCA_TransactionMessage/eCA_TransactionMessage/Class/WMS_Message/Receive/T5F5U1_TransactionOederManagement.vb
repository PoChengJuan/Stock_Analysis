...
Public Class MSG_T5F5U1_TransactionOederManagement
    ...
    Public Class clsPOInfo
      ...
      Public Class clsPODetailList
        ...
        Public Class clsPODetailInfo
          ...
          <XmlElement(ElementName:="POTransactionInfo")>
          Public Property POTransactionInfo As New clsPOTransactionInfo
          Public Class clsPOTransactionInfo
