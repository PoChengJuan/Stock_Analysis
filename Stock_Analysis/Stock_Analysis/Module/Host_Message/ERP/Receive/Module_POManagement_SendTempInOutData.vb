...
Module Module_POManagement_SendTempInOutData
  Public Function O_POManagement_SendTempInOutData(ByRef objPO As MSG_SendTempInOutData,
  ...
  Private Function Check_Data(ByVal objPO As MSG_SendTempInOutData,
                                                          ByRef ret_strResultMsg As String) As Boolean
    Try
  ...
  End Function
  '新增資料或得到要更新的資料
  Private Function Get_UpdateData(ByRef ret_PO_ID As String, ByRef ret_PO_TYPE As String, ByVal objPO_Data As MSG_SendTempInOutData,
      ...
      For Each objTempInOutDataInfo In objPO_Data.TempInOutDataList.TempInOutDataInfo
        ...
        For Each objPO_DTL In objTempInOutDataInfo.TempInOutDetailDataList.TempInOutDetailDataInfo
          ...
          If objPO_DTL.TransferInWarehouse = "110" Then
            ...
            PO_TYPE2 = "" 'enuPOType_2.temp_in
            WO_TYPE = enuWOType.Receipt
            H_PO_ORDER_TYPE = "" 'enuOrderType.temp_in
          Else
            '負數 出庫
            PO_TYPE1 = enuPOType_1.Picking_out
            PO_TYPE2 = "" 'enuPOType_2.temp_out
            WO_TYPE = enuWOType.Discharge
            H_PO_ORDER_TYPE = "" 'enuOrderType.temp_out
          End If
          Dim QTY_FINISH = 0
          Dim H_QTY_PROCESS = 0
          Dim H_POL1 = ""
