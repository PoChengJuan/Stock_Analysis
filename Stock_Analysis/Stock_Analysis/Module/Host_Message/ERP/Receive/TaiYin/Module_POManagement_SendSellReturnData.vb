...
Module Module_POManagement_SendSellReturnData
  Public Function O_POManagement_SendSellReturnData(ByRef objPO As MSG_SendSellReturnData,
    ...
    Try
      ...
      If Get_UpdateData(PO_ID, PO_TYPE, objPO, ret_strResultMsg, Host_Command, dicAdd_PO, dicUpdate_PO, dicAdd_PO_Line, dicDelete_PO_Line, dicUpdate_PO_Line, dicAdd_PO_DTL, dicDelete_PO_DTL, dicUpdate_PO_DTL, dicAdd_PO_DTL_TRANSACTION, dicDelete_PO_DTL_TRANSACTION, dicUpdate_PO_DTL_TRANSACTION) = False Then
        SendSellReturnData(enuRtnCode.Fail, PO_TYPE, PO_ID, "")
        Return False
      End If
      '取得SQL
      ...
      If Execute_DataUpdate(ret_strResultMsg, lstSql) = False Then
        ...
        Return False
      End If
      SendSellReturnData(enuRtnCode.Sucess, PO_TYPE, PO_ID, "")
      Return True
  ...
  Private Function Check_Data(ByVal objPO As MSG_SendSellReturnData,
                                                          ByRef ret_strResultMsg As String) As Boolean
    Try
      If objPO.EventID = "" Then
        ...
        Return False
      End If
      For Each objSellReturnDataInfo In objPO.SellReturnDataList.SellReturnDataInfo
        '檢查NoticeType是否為空
        If objSellReturnDataInfo.POId = "" Then
          ret_strResultMsg = "POId is empty"
          SendMessageToLog(ret_strResultMsg, eCALogTool.ILogTool.enuTrcLevel.lvWARN)
          Return False
        End If
        '檢查NoticeId是否為空
        If objSellReturnDataInfo.POType = "" Then
          ret_strResultMsg = "POType is empty"
          SendMessageToLog(ret_strResultMsg, eCALogTool.ILogTool.enuTrcLevel.lvWARN)
          Return False
        End If
        For Each objSellReturnDetailDataInfo In objSellReturnDataInfo.SellReturnDetailDataList.SellReturnDetailDataInfo
          '檢查NoticeSerialId是否為空
          If objSellReturnDetailDataInfo.SerialId = "" Then
            ret_strResultMsg = "SerialId is empty"
            SendMessageToLog(ret_strResultMsg, eCALogTool.ILogTool.enuTrcLevel.lvWARN)
            Return False
          End If
          '檢查SKU是否為空
          If objSellReturnDetailDataInfo.SKU = "" Then
          ...
          'End If
          '檢查QTY是否為空
          If objSellReturnDetailDataInfo.CheckQty = "" Then
            ret_strResultMsg = "CheckQty is empty"
            SendMessageToLog(ret_strResultMsg, eCALogTool.ILogTool.enuTrcLevel.lvWARN)
            Return False
          End If
          'Dim QTY = CInt(objSellReturnDetailDataInfo.CheckQty)
          If IsNumeric(objSellReturnDetailDataInfo.CheckQty) = False Then
  ...
  End Function
  '新增資料或得到要更新的資料
  Private Function Get_UpdateData(ByRef ret_PO_ID As String, ByRef ret_PO_TYPE As String, ByVal objPO_Data As MSG_SendSellReturnData,
    ...
    Try
      ...
      For Each objSellReturnDataInfo In objPO_Data.SellReturnDataList.SellReturnDataInfo
        Dim PO_ID As String = objSellReturnDataInfo.POType & "_" & objSellReturnDataInfo.POId
      ...
      End If
      For Each objSellReturnDataInfo In objPO_Data.SellReturnDataList.SellReturnDataInfo
        Dim Warehouse = objSellReturnDataInfo.Warehouse

        'Dim obj = objNoticeDataInfo.NoticeDetailDataList.NoticeDetailDataInfo.First
        Dim PO_KEY1 = objSellReturnDataInfo.POType
        Dim PO_KEY2 = objSellReturnDataInfo.POId
        Dim PO_KEY3 = ""
        Dim PO_KEY4 = ""
        Dim PO_KEY5 = ""

        Dim PO_ID = PO_KEY1 & "_" & PO_KEY2 '領/退料單號
        ret_PO_ID = objSellReturnDataInfo.POId
        Dim PO_TYPE1 = enuPOType_1.Combination_in
        Dim PO_TYPE2 = enuPOType_2.Sell_Back
        Dim PO_TYPE3 = ""
        Dim WO_TYPE = enuWOType.Receipt
        Dim H_PO_ORDER_TYPE = enuOrderType.Sell_Back
        PickingData_TYPE = ""
        ...
        Dim H_PO1 = objSellReturnDataInfo.POType             '單別
        ret_PO_TYPE = objSellReturnDataInfo.POType
        Dim H_PO2 = objSellReturnDataInfo.SellReturnDateTime    '單據日期
        Dim H_PO3 = objSellReturnDataInfo.FactoryId          '廠別代號
        Dim H_PO4 = ""
        Dim H_PO5 = ""
        Dim H_PO6 = ""
        Dim H_PO7 = ""
        ...
        For Each objPO_DTL In objSellReturnDataInfo.SellReturnDetailDataList.SellReturnDetailDataInfo
          '檢查料品主檔是否存在
          ...
          Dim TO_OWNER_ID = objSellReturnDataInfo.FactoryId
          Dim TO_SUB_OWNER_ID = ""
          Dim FACTORY_ID = ""
          Dim DEST_AREA_ID = ""
