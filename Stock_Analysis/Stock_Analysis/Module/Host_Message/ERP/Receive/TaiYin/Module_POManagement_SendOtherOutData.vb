...
Module Module_POManagement_SendOtherOutData
  Public Function O_POManagement_SendOtherOutData(ByRef objPO As MSG_SendOtherOutData,
    ...
    Try
      ...
      If Get_UpdateData(PO_ID, PO_TYPE, objPO, ret_strResultMsg, Host_Command, dicAdd_PO, dicUpdate_PO, dicAdd_PO_Line, dicDelete_PO_Line, dicUpdate_PO_Line, dicAdd_PO_DTL, dicDelete_PO_DTL, dicUpdate_PO_DTL, dicAdd_PO_DTL_TRANSACTION, dicDelete_PO_DTL_TRANSACTION, dicUpdate_PO_DTL_TRANSACTION) = False Then
        SendOtherOutData(enuRtnCode.Fail, PO_TYPE, PO_ID, "")
        Return False
      End If
      '取得SQL
      ...
      If Execute_DataUpdate(ret_strResultMsg, lstSql) = False Then
        ...
        Return False
      End If
      SendOtherOutData(enuRtnCode.Sucess, PO_TYPE, PO_ID, "")
      Return True
  ...
  Private Function Check_Data(ByVal objPO As MSG_SendOtherOutData,
                                                          ByRef ret_strResultMsg As String) As Boolean
    Try
      If objPO.EventID = "" Then
        ...
        Return False
      End If
      For Each objOtherOutDataInfo In objPO.OtherOutDataList.OtherOutDataInfo
        '檢查NoticeType是否為空
        If objOtherOutDataInfo.POId = "" Then
          ret_strResultMsg = "POId is empty"
          SendMessageToLog(ret_strResultMsg, eCALogTool.ILogTool.enuTrcLevel.lvWARN)
          Return False
        End If
        '檢查NoticeId是否為空
        If objOtherOutDataInfo.POType = "" Then
          ret_strResultMsg = "POType is empty"
          SendMessageToLog(ret_strResultMsg, eCALogTool.ILogTool.enuTrcLevel.lvWARN)
          Return False
        End If
        For Each objOtherOutDetailDataInfo In objOtherOutDataInfo.OtherOutDetailDataList.OtherOutDetailDataInfo
          '檢查NoticeSerialId是否為空
          If objOtherOutDetailDataInfo.SerialId = "" Then
            ret_strResultMsg = "SerialId is empty"
            SendMessageToLog(ret_strResultMsg, eCALogTool.ILogTool.enuTrcLevel.lvWARN)
            Return False
          End If
          '檢查SKU是否為空
          If objOtherOutDetailDataInfo.SKU = "" Then
          ...
          'End If
          '檢查QTY是否為空
          If objOtherOutDetailDataInfo.CheckQty = "" Then
            ret_strResultMsg = "CheckQty is empty"
            SendMessageToLog(ret_strResultMsg, eCALogTool.ILogTool.enuTrcLevel.lvWARN)
            Return False
          End If
          'Dim QTY = CInt(objOtherOutDetailDataInfo.CheckQty)
          If IsNumeric(objOtherOutDetailDataInfo.CheckQty) = False Then
  ...
  End Function
  '新增資料或得到要更新的資料
  Private Function Get_UpdateData(ByRef ret_PO_ID As String, ByRef ret_PO_TYPE As String, ByVal objPO_Data As MSG_SendOtherOutData,
    ...
    Try
      ...
      For Each objOtherOutDataInfo In objPO_Data.OtherOutDataList.OtherOutDataInfo
        Dim PO_ID As String = objOtherOutDataInfo.POType & "_" & objOtherOutDataInfo.POId
      ...
      End If
      For Each objOtherOutDataInfo In objPO_Data.OtherOutDataList.OtherOutDataInfo
        Dim Warehouse = objOtherOutDataInfo.Warehouse

        'Dim obj = objNoticeDataInfo.NoticeDetailDataList.NoticeDetailDataInfo.First
        Dim PO_KEY1 = objOtherOutDataInfo.POType
        Dim PO_KEY2 = objOtherOutDataInfo.POId
        Dim PO_KEY3 = ""
        Dim PO_KEY4 = ""
        Dim PO_KEY5 = ""

        Dim PO_ID = PO_KEY1 & "_" & PO_KEY2  '
        ret_PO_ID = objOtherOutDataInfo.POId
        Dim PO_TYPE1 = enuPOType_1.Picking_out
        Dim PO_TYPE2 = "" 'enuPOType_2.OtherOutData
        Dim PO_TYPE3 = ""
        Dim WO_TYPE = enuWOType.Discharge
        Dim H_PO_ORDER_TYPE = "" 'enuOrderType.OtherOutData
        PickingData_TYPE = ""
        ...
        Dim H_PO1 = objOtherOutDataInfo.POType             '單別
        ret_PO_TYPE = objOtherOutDataInfo.POType
        Dim H_PO2 = objOtherOutDataInfo.OtherOutDateTime    '單據日期
        Dim H_PO3 = objOtherOutDataInfo.FactoryId          '廠別代號
        Dim H_PO4 = ""
        Dim H_PO5 = ""
        Dim H_PO6 = ""
        Dim H_PO7 = ""
        ...
        For Each objPO_DTL In objOtherOutDataInfo.OtherOutDetailDataList.OtherOutDetailDataInfo
          '檢查料品主檔是否存在
          ...
          Dim FROM_OWNER_ID = objOtherOutDataInfo.FactoryId
