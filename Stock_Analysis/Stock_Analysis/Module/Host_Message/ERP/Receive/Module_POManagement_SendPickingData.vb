...
Module Module_POManagement_SendPickingData
  Public Function O_POManagement_SendPickingData(ByRef objPO As MSG_SendPickingData,
  ...
  Private Function Check_Data(ByVal objPO As MSG_SendPickingData,
                                                          ByRef ret_strResultMsg As String) As Boolean
    Try
  ...
  End Function
  '新增資料或得到要更新的資料
  Private Function Get_UpdateData(ByRef ret_PO_ID As String, ByRef ret_PO_TYPE As String, ByVal objPO_Data As MSG_SendPickingData,
