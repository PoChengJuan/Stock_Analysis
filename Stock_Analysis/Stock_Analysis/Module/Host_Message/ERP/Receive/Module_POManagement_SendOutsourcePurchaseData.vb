...
Module Module_POManagement_SendOutsourcePurchaseData
  Public Function O_POManagement_SendOutsourcePurchaseData(ByRef objPO As MSG_SendOutsourceData,
    ...
    Try
      ...
      If Get_UpdateData(PO_ID, PO_TYPE, objPO, ret_strResultMsg, Host_Command, dicAdd_PO, dicUpdate_PO, dicAdd_PO_Line, dicDelete_PO_Line, dicUpdate_PO_Line, dicAdd_PO_DTL, dicDelete_PO_DTL, dicUpdate_PO_DTL, dicAdd_PO_DTL_TRANSACTION, dicDelete_PO_DTL_TRANSACTION, dicUpdate_PO_DTL_TRANSACTION) = False Then
        SendOutsourcePurchaseData(enuRtnCode.Fail, PO_TYPE, PO_ID, ret_strResultMsg)
        Return False
      End If
      '取得SQL
      ...
      If Execute_DataUpdate(ret_strResultMsg, lstSql) = False Then
        ...
        Return False
      End If
      SendOutsourcePurchaseData(enuRtnCode.Sucess, PO_TYPE, PO_ID, ret_strResultMsg)
      Return True
  ...
  Private Function Check_Data(ByVal objPO As MSG_SendOutsourceData,
                                                          ByRef ret_strResultMsg As String) As Boolean
    Try
      If objPO.EventID = "" Then
        ...
        Return False
      End If
      For Each objOutsourcePurchaseDataInfo In objPO.OutsourcePurchaseDataList.OutsourcePurchaseDataInfo
        '檢查NoticeType是否為空
        If objOutsourcePurchaseDataInfo.POId = "" Then
          ret_strResultMsg = "POId is empty"
          SendMessageToLog(ret_strResultMsg, eCALogTool.ILogTool.enuTrcLevel.lvWARN)
          Return False
        End If
        '檢查NoticeId是否為空
        If objOutsourcePurchaseDataInfo.POType = "" Then
          ret_strResultMsg = "POType is empty"
          SendMessageToLog(ret_strResultMsg, eCALogTool.ILogTool.enuTrcLevel.lvWARN)
          Return False
        End If

        For Each objOutsourcePurchaseDetailDataInfo In objOutsourcePurchaseDataInfo.OutsourcePurchaseDetailDataList.OutsourcePurchaseDetailDataInfo
          '檢查NoticeSerialId是否為空
          If objOutsourcePurchaseDetailDataInfo.SerialId = "" Then
            ret_strResultMsg = "SerialId is empty"
            SendMessageToLog(ret_strResultMsg, eCALogTool.ILogTool.enuTrcLevel.lvWARN)
            Return False
          End If
          '檢查SKU是否為空
          If objOutsourcePurchaseDetailDataInfo.SKU = "" Then
            ret_strResultMsg = "SKU is empty"
            SendMessageToLog(ret_strResultMsg, eCALogTool.ILogTool.enuTrcLevel.lvWARN)
            Return False
          End If
          '檢查SKU是否為空
          If objOutsourcePurchaseDetailDataInfo.Unit = "" Then
            ret_strResultMsg = "Unit is empty"
            SendMessageToLog(ret_strResultMsg, eCALogTool.ILogTool.enuTrcLevel.lvWARN)
            Return False
          End If
          '檢查QTY是否為空
          If objOutsourcePurchaseDetailDataInfo.CheckQty = "" Then
            ret_strResultMsg = "PickingQty is empty"
            SendMessageToLog(ret_strResultMsg, eCALogTool.ILogTool.enuTrcLevel.lvWARN)
            Return False
          End If
          'Dim QTY = CInt(objOutsourcePurchaseDetailDataInfo.CheckQty)
          If IsNumeric(objOutsourcePurchaseDetailDataInfo.CheckQty) = False Then
  ...
  End Function
  '新增資料或得到要更新的資料
  Private Function Get_UpdateData(ByRef ret_PO_ID As String, ByRef ret_PO_TYPE As String, ByVal objPO_Data As MSG_SendOutsourceData,
    ...
    Try
      ...
      For Each objOutsourcePurchaseDataInfo In objPO_Data.OutsourcePurchaseDataList.OutsourcePurchaseDataInfo
        Dim PO_ID As String = objOutsourcePurchaseDataInfo.POType & "_" & objOutsourcePurchaseDataInfo.POId
      ...
      For Each objOutsourcePurchaseDataInfo In objPO_Data.OutsourcePurchaseDataList.OutsourcePurchaseDataInfo
        ...
        Dim PO_ID = objOutsourcePurchaseDataInfo.POType & "_" & objOutsourcePurchaseDataInfo.POId  '託外進貨單號
        ret_PO_ID = objOutsourcePurchaseDataInfo.POId
        Dim PO_TYPE1 = enuPOType_1.Combination_in
        Dim PO_TYPE2 = "" 'enuPOType_2.other_in
        Dim PO_TYPE3 = ""
        Dim WO_TYPE = enuWOType.Receipt
        Dim H_PO_ORDER_TYPE = enuOrderType.other_in
        Dim PRIORITY = "50"
        'Dim CREATE_TIME = ""
        Dim START_TIME = ""
        Dim FINISH_TIME = ""
        ...
        Dim H_PO1 = objOutsourcePurchaseDataInfo.POType             '單別
        ret_PO_TYPE = H_PO1
        Dim H_PO2 = objOutsourcePurchaseDataInfo.OutsourcePurchaseDateTime  '單據日期
        Dim H_PO3 = objOutsourcePurchaseDataInfo.FactoryId          '廠別代號
        Dim H_PO4 = ""
        Dim H_PO5 = ""
        Dim H_PO6 = objOutsourcePurchaseDataInfo.ConfirmCode        '確認碼
        Dim H_PO7 = ""
        Dim H_PO8 = ""
        Dim H_PO9 = ""
        Dim H_PO10 = ""
        ...
        For Each objPO_DTL In objOutsourcePurchaseDataInfo.OutsourcePurchaseDetailDataList.OutsourcePurchaseDetailDataInfo
          '檢查料品主檔是否存在
          ...
          Dim H_POD2 = objPO_DTL.WarehouseId      '庫別
          Dim H_POD3 = objPO_DTL.ShelfId          '儲位
          Dim H_POD4 = ""
          Dim H_POD5 = ""
          Dim H_POD6 = ""
          Dim H_POD7 = ""
...
#End Region
      ...
      'For Each objOutsourcePurchaseDataInfo In objPO_Data.OutsourceDataList.OutsourceDataInfo
      '  Dim PO_ID As String = objOutsourcePurchaseDataInfo.POId
      '  Dim PO_TYPE As String = objOutsourcePurchaseDataInfo.POType
      '  SendOutsourcePurchaseData(enuRtnCode.Sucess, PO_TYPE, PO_ID, ret_strResultMsg)
      'Next
