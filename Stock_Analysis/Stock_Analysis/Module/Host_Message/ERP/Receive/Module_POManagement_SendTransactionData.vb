...
Module Module_POManagement_SendTransactionData
  Public Function O_POManagement_SendTransactionData(ByRef objPO As MSG_SendTransactionData,
  ...
  Private Function Check_Data(ByVal objPO As MSG_SendTransactionData,
                                                          ByRef ret_strResultMsg As String) As Boolean
    Try
  ...
  End Function
  '新增資料或得到要更新的資料
  Private Function Get_UpdateData(ByRef ret_PO_ID As String, ByRef ret_PO_TYPE As String, ByRef DocTypeCode As String, ByVal objPO_Data As MSG_SendTransactionData,
    ...
    Try
      ...
      For Each objTransactionDataInfo In objPO_Data.TransactionDataList.TransactionDataInfo
        ...
        For Each objPO_DTL In objTransactionDataInfo.TransactionDetailDataList.TransactionDetailDataInfo
          ...
          Else
            '轉撥單
            If objPO_DTL.TransferOutWarehouse = "110" Then
              '轉撥出
              PO_TYPE1 = enuPOType_1.Picking_out
              PO_TYPE2 = "" 'enuPOType_2.transaction_out
              WO_TYPE = enuWOType.Discharge
              H_PO_ORDER_TYPE = "" 'enuOrderType.transaction_out
            ElseIf objPO_DTL.TransferInWarehouse = "110" Then
              '轉撥入
              PO_TYPE1 = enuPOType_1.Combination_in
