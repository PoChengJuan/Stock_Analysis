...
Module Module_T5F1S3_POReceiptReport
  Public Function O_T5F1S3_POReceiptReport(ByVal Receive_Msg As MSG_T5F1S3_POReceiptReport,
  ...
  Public Function Check_Data(ByVal Receive_Msg As MSG_T5F1S3_POReceiptReport,
                             ByRef ret_strResultMsg As String) As Boolean
    Try
      '先進行資料邏輯檢查
  ...
  Public Function Process_Data(ByVal Receive_Msg As MSG_T5F1S3_POReceiptReport,
                             ByRef ret_strResultMsg As String) As Boolean
    Try
      '準備資料
