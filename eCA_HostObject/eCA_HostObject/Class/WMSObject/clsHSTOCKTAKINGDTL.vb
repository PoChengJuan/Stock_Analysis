Public Class clsHSTOCKTAKINGDTL
Private ShareName As String = "HSTOCKTAKINGDTL"
...
Private _HIST_TIME As String '紀錄時間
 ...
 End Property
  ...
  Public Sub New(ByVal STOCKTAKING_ID As  String,ByVal STOCKTAKING_SERIAL_NO As  String,ByVal AREA_NO As  String,ByVal BLOCK_NO As  String,ByVal SKU_NO As  String,ByVal OWNER_NO As  String,ByVal SUB_OWNER_NO As  String,ByVal SL_NO As  String,ByVal STORAGE_TYPE As  String,ByVal BND As  String,ByVal CARRIER_ID As  String,ByVal PERCENTAGE As  Long,ByVal CARRIER_QTY As  Long,ByVal CARRIER_QTY_CHECKED As  Long,ByVal LOT_NO As  String,ByVal ITEM_COMMON1 As  String,ByVal ITEM_COMMON2 As  String,ByVal ITEM_COMMON3 As  String,ByVal ITEM_COMMON4 As  String,ByVal ITEM_COMMON5 As  String,ByVal ITEM_COMMON6 As  String,ByVal ITEM_COMMON7 As  String,ByVal ITEM_COMMON8 As  String,ByVal ITEM_COMMON9 As  String,ByVal ITEM_COMMON10 As  String,ByVal SORT_ITEM_COMMON1 As  String,ByVal SORT_ITEM_COMMON2 As  String,ByVal SORT_ITEM_COMMON3 As  String,ByVal SORT_ITEM_COMMON4 As  String,ByVal SORT_ITEM_COMMON5 As  String,ByVal SUPPLIER_NO As  String,ByVal CUSTOMER_NO As  String,ByVal RECEIPT_DATE As  String,ByVal MANUFACETURE_DATE As  String,ByVal EXPIRED_DATE As  String,ByVal ERP_QTY As  Double,ByVal HIST_TIME As  String)
 MyBase.New()
 Try
...
Public Shared Function Get_Combination_Key(ByVal STOCKTAKING_ID As  String,ByVal STOCKTAKING_SERIAL_NO As  String) As String
 ...
 End Try
 End Function
Public Function Clone() As clsHSTOCKTAKINGDTL
 Try
 ...
 Try
Dim strSQL As String = WMS_H_STOCKTAKING_DTLManagement.GetInsertSQL(Me)
 lstSQL.Add(strSQL)
 Return True
 Catch ex As Exception
 SendMessageToLog(ex.ToString, eCALogTool.ILogTool.enuTrcLevel.lvError)
...
Public Function O_Add_Update_SQLString(ByRef lstSQL As List(Of String)) As Boolean
 Try
 Dim strSQL As String = WMS_H_STOCKTAKING_DTLManagement.GetUpdateSQL(Me)
 lstSQL.Add(strSQL)
 Return True
 Catch ex As Exception
 SendMessageToLog(ex.ToString, eCALogTool.ILogTool.enuTrcLevel.lvError)
...
Public Function O_Add_Delete_SQLString(ByRef lstSQL As List(Of String)) As Boolean
 Try
 Dim strSQL As String = WMS_H_STOCKTAKING_DTLManagement.GetDeleteSQL(Me)
 lstSQL.Add(strSQL)
 Return True
 Catch ex As Exception
 SendMessageToLog(ex.ToString, eCALogTool.ILogTool.enuTrcLevel.lvError)
 ...
 End Try
 End Function
Public Function Update_To_Memory(ByRef objWMS_H_STOCKTAKING_DTL As  clsHSTOCKTAKINGDTL) As Boolean
Try
Dim key As String = objWMS_H_STOCKTAKING_DTL._gid
 If key <> _gid Then
 SendMessageToLog("Key can not Update, old_Key="& _gid & ",new_key=" &  key,eCALogTool.ILogTool.enuTrcLevel.lvWARN)
 Return False
 End If
_STOCKTAKING_ID = objWMS_H_STOCKTAKING_DTL.STOCKTAKING_ID
_STOCKTAKING_SERIAL_NO = objWMS_H_STOCKTAKING_DTL.STOCKTAKING_SERIAL_NO
_AREA_NO = objWMS_H_STOCKTAKING_DTL.AREA_NO
_BLOCK_NO = objWMS_H_STOCKTAKING_DTL.BLOCK_NO
_SKU_NO = objWMS_H_STOCKTAKING_DTL.SKU_NO
_OWNER_NO = objWMS_H_STOCKTAKING_DTL.OWNER_NO
_SUB_OWNER_NO = objWMS_H_STOCKTAKING_DTL.SUB_OWNER_NO
_SL_NO = objWMS_H_STOCKTAKING_DTL.SL_NO
_STORAGE_TYPE = objWMS_H_STOCKTAKING_DTL.STORAGE_TYPE
_BND = objWMS_H_STOCKTAKING_DTL.BND
_CARRIER_ID = objWMS_H_STOCKTAKING_DTL.CARRIER_ID
_PERCENTAGE = objWMS_H_STOCKTAKING_DTL.PERCENTAGE
_CARRIER_QTY = objWMS_H_STOCKTAKING_DTL.CARRIER_QTY
_CARRIER_QTY_CHECKED = objWMS_H_STOCKTAKING_DTL.CARRIER_QTY_CHECKED
_LOT_NO = objWMS_H_STOCKTAKING_DTL.LOT_NO
_ITEM_COMMON1 = objWMS_H_STOCKTAKING_DTL.ITEM_COMMON1
_ITEM_COMMON2 = objWMS_H_STOCKTAKING_DTL.ITEM_COMMON2
_ITEM_COMMON3 = objWMS_H_STOCKTAKING_DTL.ITEM_COMMON3
_ITEM_COMMON4 = objWMS_H_STOCKTAKING_DTL.ITEM_COMMON4
_ITEM_COMMON5 = objWMS_H_STOCKTAKING_DTL.ITEM_COMMON5
_ITEM_COMMON6 = objWMS_H_STOCKTAKING_DTL.ITEM_COMMON6
_ITEM_COMMON7 = objWMS_H_STOCKTAKING_DTL.ITEM_COMMON7
_ITEM_COMMON8 = objWMS_H_STOCKTAKING_DTL.ITEM_COMMON8
_ITEM_COMMON9 = objWMS_H_STOCKTAKING_DTL.ITEM_COMMON9
_ITEM_COMMON10 = objWMS_H_STOCKTAKING_DTL.ITEM_COMMON10
_SORT_ITEM_COMMON1 = objWMS_H_STOCKTAKING_DTL.SORT_ITEM_COMMON1
_SORT_ITEM_COMMON2 = objWMS_H_STOCKTAKING_DTL.SORT_ITEM_COMMON2
_SORT_ITEM_COMMON3 = objWMS_H_STOCKTAKING_DTL.SORT_ITEM_COMMON3
_SORT_ITEM_COMMON4 = objWMS_H_STOCKTAKING_DTL.SORT_ITEM_COMMON4
_SORT_ITEM_COMMON5 = objWMS_H_STOCKTAKING_DTL.SORT_ITEM_COMMON5
_SUPPLIER_NO = objWMS_H_STOCKTAKING_DTL.SUPPLIER_NO
_CUSTOMER_NO = objWMS_H_STOCKTAKING_DTL.CUSTOMER_NO
_RECEIPT_DATE = objWMS_H_STOCKTAKING_DTL.RECEIPT_DATE
_MANUFACETURE_DATE = objWMS_H_STOCKTAKING_DTL.MANUFACETURE_DATE
_EXPIRED_DATE = objWMS_H_STOCKTAKING_DTL.EXPIRED_DATE
_ERP_QTY = objWMS_H_STOCKTAKING_DTL.ERP_QTY
_HIST_TIME = objWMS_H_STOCKTAKING_DTL.HIST_TIME
 Return True
 Catch ex As Exception
 SendMessageToLog(ex.ToString, eCALogTool.ILogTool.enuTrcLevel.lvError)
 Return False
