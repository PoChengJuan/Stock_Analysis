Public Class clsWMS_CH_INVENTORY_COMPARISON
  Private ShareName As String = "WMS_CH_INVENTORY_COMPARISON"
  ...
  Public Sub New(ByVal SKU_NO As String, ByVal LOT_NO As String, ByVal ITEM_COMMON1 As String, ByVal ITEM_COMMON2 As String, ByVal ITEM_COMMON3 As String, ByVal ITEM_COMMON4 As String, ByVal ITEM_COMMON5 As String, ByVal ITEM_COMMON6 As String, ByVal ITEM_COMMON7 As String, ByVal ITEM_COMMON8 As String, ByVal ITEM_COMMON9 As String, ByVal ITEM_COMMON10 As String, ByVal SORT_ITEM_COMMON1 As String, ByVal SORT_ITEM_COMMON2 As String, ByVal SORT_ITEM_COMMON3 As String, ByVal SORT_ITEM_COMMON4 As String, ByVal SORT_ITEM_COMMON5 As String, ByVal OWNER_NO As String, ByVal SUB_OWNER_NO As String, ByVal STORAGE_TYPE As Double, ByVal BND As Double, ByVal QC_STATUS As Double, ByVal WMS_STOCK_QTY As Double, ByVal WMS_UNFINISH_QTY As Double, ByVal WMS_COMPARSON_QTY As Double, ByVal ERP_STOCK_QTY As Double, ByVal ERP_UNFINISH_QTY As Double, ByVal ERP_COMPARSON_QTY As Double, ByVal QUANTITY_VARIANCE As Double, ByVal ERP_SYSTEM As String, ByVal CREATE_TIME As String, ByVal ACC_COMMON1 As String, ByVal ACC_COMMON2 As String, ByVal ACC_COMMON3 As String, ByVal ACC_COMMON4 As String, ByVal ACC_COMMON5 As String, ByVal ACC_COMMON6 As String, ByVal ACC_COMMON7 As String, ByVal ACC_COMMON8 As String, ByVal ACC_COMMON9 As String, ByVal ACC_COMMON10 As String, ByVal HIST_TIME As String)
    MyBase.New()
    Try
  ...
  '=================Public Function=======================
  '傳入指定參數取得Key值
  Public Function Clone() As clsWMS_CH_INVENTORY_COMPARISON
    Try
  ...
  '  Try
  '    Dim strSQL As String = WMS_CH_INVENTORY_COMPARISONManagement.GetInsertSQL(Me)
  '    lstSQL.Add(strSQL)
  '    Return True
  '  Catch ex As Exception
  '    SendMessageToLog(ex.ToString, eCALogTool.ILogTool.enuTrcLevel.lvError)
  ...
  '  Try
  '    Dim strSQL As String = WMS_CH_INVENTORY_COMPARISONManagement.GetUpdateSQL(Me)
  '    lstSQL.Add(strSQL)
  '    Return True
  '  Catch ex As Exception
  '    SendMessageToLog(ex.ToString, eCALogTool.ILogTool.enuTrcLevel.lvError)
  ...
  '  Try
  '    Dim strSQL As String = WMS_CH_INVENTORY_COMPARISONManagement.GetDeleteSQL(Me)
  '    lstSQL.Add(strSQL)
  '    Return True
  '  Catch ex As Exception
  '    SendMessageToLog(ex.ToString, eCALogTool.ILogTool.enuTrcLevel.lvError)
  ...
  '  End Try
  'End Function
  'Public Function Update_To_Memory(ByRef objWMS_CH_INVENTORY_COMPARISON As clsWMS_CH_INVENTORY_COMPARISON) As Boolean
  '  Try
  '    Dim key As String = objWMS_CH_INVENTORY_COMPARISON._gid
  '    If key <> _gid Then
