Public Class clsHSTOCKTAKING
Private ShareName As String = "HSTOCKTAKING"
...
Private _UPLOAD_COMMENTS As String'上傳狀態為Fail時註明失敗原因
...
Public Shared Function Get_Combination_Key(ByVal STOCKTAKING_ID As  String) As String
 ...
 End Try
 End Function
Public Function Clone() As clsHSTOCKTAKING
 Try
 ...
 Try
Dim strSQL As String = WMS_H_STOCKTAKINGManagement.GetInsertSQL(Me)
 lstSQL.Add(strSQL)
 Return True
 Catch ex As Exception
 SendMessageToLog(ex.ToString, eCALogTool.ILogTool.enuTrcLevel.lvError)
...
Public Function O_Add_Update_SQLString(ByRef lstSQL As List(Of String)) As Boolean
 Try
 Dim strSQL As String = WMS_H_STOCKTAKINGManagement.GetUpdateSQL(Me)
 lstSQL.Add(strSQL)
 Return True
 Catch ex As Exception
 SendMessageToLog(ex.ToString, eCALogTool.ILogTool.enuTrcLevel.lvError)
...
Public Function O_Add_Delete_SQLString(ByRef lstSQL As List(Of String)) As Boolean
 Try
 Dim strSQL As String = WMS_H_STOCKTAKINGManagement.GetDeleteSQL(Me)
 lstSQL.Add(strSQL)
 Return True
 Catch ex As Exception
 SendMessageToLog(ex.ToString, eCALogTool.ILogTool.enuTrcLevel.lvError)
 ...
 End Try
 End Function
Public Function Update_To_Memory(ByRef objWMS_H_STOCKTAKING As  clsHSTOCKTAKING) As Boolean
Try
Dim key As String = objWMS_H_STOCKTAKING._gid
 If key <> _gid Then
 SendMessageToLog("Key can not Update, old_Key="& _gid & ",new_key=" &  key,eCALogTool.ILogTool.enuTrcLevel.lvWARN)
 Return False
 End If
_STOCKTAKING_ID = objWMS_H_STOCKTAKING.STOCKTAKING_ID
_STOCKTAKING_TYPE1 = objWMS_H_STOCKTAKING.STOCKTAKING_TYPE1
_STOCKTAKING_TYPE2 = objWMS_H_STOCKTAKING.STOCKTAKING_TYPE2
_STOCKTAKING_TYPE3 = objWMS_H_STOCKTAKING.STOCKTAKING_TYPE3
_CREATE_TIME = objWMS_H_STOCKTAKING.CREATE_TIME
_START_TIME = objWMS_H_STOCKTAKING.START_TIME
_FINISH_TIME = objWMS_H_STOCKTAKING.FINISH_TIME
_CREATE_USER = objWMS_H_STOCKTAKING.CREATE_USER
_STATUS = objWMS_H_STOCKTAKING.STATUS
_LOCATION_GROUP_NO = objWMS_H_STOCKTAKING.LOCATION_GROUP_NO
_PRIORITY = objWMS_H_STOCKTAKING.PRIORITY
_CARRIER_QTY = objWMS_H_STOCKTAKING.CARRIER_QTY
_CARRIER_QTY_CHECKED = objWMS_H_STOCKTAKING.CARRIER_QTY_CHECKED
_MATCH_TYPE = objWMS_H_STOCKTAKING.MATCH_TYPE
_SEND_TO_HOST = objWMS_H_STOCKTAKING.SEND_TO_HOST
_CHANGE_INVENTORY = objWMS_H_STOCKTAKING.CHANGE_INVENTORY
_UPLOAD_STATUS = objWMS_H_STOCKTAKING.UPLOAD_STATUS
_UPLOAD_COMMENTS = objWMS_H_STOCKTAKING.UPLOAD_COMMENTS
_HIST_TIME = objWMS_H_STOCKTAKING.HIST_TIME
 Return True
 Catch ex As Exception
 SendMessageToLog(ex.ToString, eCALogTool.ILogTool.enuTrcLevel.lvError)
 Return False
