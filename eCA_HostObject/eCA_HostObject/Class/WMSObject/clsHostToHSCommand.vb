Public Class clsHostToHSCommand
  Private ShareName As String = "HHSCOMMAND"
  ...
  Private _RECEIVE_SYSTEM As Long '接收的系統名稱遇到新的再增加Enum
  ...
  Public Property CONNECTION_TYPE() As Long
    ...
    End Set
  End Property
  Public Property RECEIVE_SYSTEM() As Long
    Get
  ...
  Public Sub New(ByVal UUID As String, ByVal CONNECTION_TYPE As Long, ByVal RECEIVE_SYSTEM As Long, ByVal FUNCTION_ID As String, ByVal SEQ As Long, ByVal USER_ID As String, ByVal CLIENT_ID As String, ByVal IP As String, ByVal CREATE_TIME As String, ByVal MESSAGE As String, ByVal RESULT As String, ByVal RESULT_MESSAGE As String, ByVal WAIT_UUID As String, ByVal HIST_TIME As String)
    MyBase.New()
    Try
  ...
  '=================Public Function=======================
  '傳入指定參數取得Key值
  Public Function Clone() As clsHostToHSCommand
    Try
  ...
  Public Function O_Add_Insert_SQLString(ByRef lstSQL As List(Of String)) As Boolean
    Try
      Dim strSQL As String = HOST_H_HS_COMMANDManagement.GetInsertSQL(Me)
      lstSQL.Add(strSQL)
      Return True
    Catch ex As Exception
      SendMessageToLog(ex.ToString, eCALogTool.ILogTool.enuTrcLevel.lvError)
  ...
  Public Function O_Add_Update_SQLString(ByRef lstSQL As List(Of String)) As Boolean
    Try
      Dim strSQL As String = HOST_H_HS_COMMANDManagement.GetUpdateSQL(Me)
      lstSQL.Add(strSQL)
      Return True
    Catch ex As Exception
      SendMessageToLog(ex.ToString, eCALogTool.ILogTool.enuTrcLevel.lvError)
  ...
  Public Function O_Add_Delete_SQLString(ByRef lstSQL As List(Of String)) As Boolean
    Try
      Dim strSQL As String = HOST_H_HS_COMMANDManagement.GetDeleteSQL(Me)
      lstSQL.Add(strSQL)
      Return True
    Catch ex As Exception
      SendMessageToLog(ex.ToString, eCALogTool.ILogTool.enuTrcLevel.lvError)
    ...
    End Try
  End Function
  Public Function Update_To_Memory(ByRef objHOST_H_HS_COMMAND As clsHostToHSCommand) As Boolean
    Try
      Dim key As String = objHOST_H_HS_COMMAND._gid
      If key <> _gid Then
        SendMessageToLog("Key can not Update, old_Key=" & _gid & ",new_key=" & key, eCALogTool.ILogTool.enuTrcLevel.lvWARN)
        Return False
      End If
      _UUID = objHOST_H_HS_COMMAND.UUID
      _CONNECTION_TYPE = objHOST_H_HS_COMMAND.CONNECTION_TYPE
      _RECEIVE_SYSTEM = objHOST_H_HS_COMMAND.RECEIVE_SYSTEM
      _FUNCTION_ID = objHOST_H_HS_COMMAND.FUNCTION_ID
      _SEQ = objHOST_H_HS_COMMAND.SEQ
      _USER_ID = objHOST_H_HS_COMMAND.USER_ID
      _CLIENT_ID = objHOST_H_HS_COMMAND.CLIENT_ID
      _IP = objHOST_H_HS_COMMAND.IP
      _CREATE_TIME = objHOST_H_HS_COMMAND.CREATE_TIME
      _MESSAGE = objHOST_H_HS_COMMAND.MESSAGE
      _RESULT = objHOST_H_HS_COMMAND.RESULT
      _RESULT_MESSAGE = objHOST_H_HS_COMMAND.RESULT_MESSAGE
      _WAIT_UUID = objHOST_H_HS_COMMAND.WAIT_UUID
      _HIST_TIME = objHOST_H_HS_COMMAND.HIST_TIME
      Return True
    Catch ex As Exception
      SendMessageToLog(ex.ToString, eCALogTool.ILogTool.enuTrcLevel.lvError)
      Return False
