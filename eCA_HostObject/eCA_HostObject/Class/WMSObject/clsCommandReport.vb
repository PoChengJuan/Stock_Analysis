...
Public Class clsCommandReport
  Private ShareName As String = "CommandReport"
  ...
  Public Function O_Add_Insert_SQLString(ByRef lstSQL As List(Of String)) As Boolean
    Try
      Dim strSQL As String = WMS_T_COMMAND_REPORT.GetInsertSQL(Me)
      lstSQL.Add(strSQL)
      Return True
    Catch ex As Exception
      SendMessageToLog(ex.ToString, eCALogTool.ILogTool.enuTrcLevel.lvError)
  ...
  Public Function O_Add_Delete_SQLString(ByRef lstSQL As List(Of String)) As Boolean
    Try
      Dim strSQL As String = WMS_T_COMMAND_REPORT.GetDeleteSQL(Me)
      lstSQL.Add(strSQL)
      Return True
    Catch ex As Exception
      SendMessageToLog(ex.ToString, eCALogTool.ILogTool.enuTrcLevel.lvError)
  ...
  Public Sub Add_Relationship(ByRef objHost As clsHandlingObject)
    Try
      ...
      If objHost IsNot Nothing Then
        _objHost = objHost
        objHost.O_Add_Command_Report(Me)
      End If
    Catch ex As Exception
      SendMessageToLog(ex.ToString, eCALogTool.ILogTool.enuTrcLevel.lvError)
    End Try
  ...
  End Sub
  '用另一個物件的資料，更新物件資料
  Public Function Update_To_Memory(ByRef obj As clsCommandReport) As Boolean
    Try
