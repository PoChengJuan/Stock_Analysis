...
Public Class GUI_H_Command_HistManagement
  Public Shared TableName As String = "GUI_H_Command_Hist"
  ...
  Enum IdxColumnName As Integer
    ...
    HIST_TIME
  End Enum
  Public Shared Function GetInsertSQL(ByRef Info As clsFromGUICommandHist) As String
    Try
