...
Public Class WMS_H_MCS_Command_HistManagement
  Public Shared TableName As String = "WMS_H_MCS_Command_Hist"
  ...
  Enum IdxColumnName As Integer
    ...
    HIST_TIME
  End Enum
  Public Shared Function GetInsertSQL(ByRef Info As clsToMCSCommandHist) As String
    Try
