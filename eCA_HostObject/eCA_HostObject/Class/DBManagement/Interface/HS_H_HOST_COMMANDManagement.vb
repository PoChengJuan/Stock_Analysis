Partial Class HS_H_HOST_COMMANDManagement
  Public Shared TableName As String = "HS_H_HOST_COMMAND"
  ...
  End Enum
  '- GetSQL
  Public Shared Function GetInsertSQL(ByRef Info As clsHSToHostCommand) As String
    Try
    ...
    End Try
  End Function
  Public Shared Function GetUpdateSQL(ByRef Info As clsHSToHostCommand) As String
    Try
      Dim strSQL As String = ""
    ...
    End Try
  End Function
  Public Shared Function GetDeleteSQL(ByRef Info As clsHSToHostCommand) As String
    Try
      Dim strSQL As String = ""
  ...
  Private Shared Function SetInfoFromDB(ByRef Info As clsHSToHostCommand, ByRef RowData As DataRow) As Boolean
    Try
      If RowData IsNot Nothing Then
        ...
        Info = New clsHSToHostCommand(UUID, CONNECTION_TYPE, SEND_SYSTEM, FUNCTION_ID, SEQ, USER_ID, CLIENT_ID, IP, CREATE_TIME, MESSAGE, RESULT, RESULT_MESSAGE, WAIT_UUID, HIST_TIME)
    ...
    End Try
  End Function
  Public Shared Function GetHS_H_HOST_COMMANDListByALL() As List(Of clsHSToHostCommand)
    Try
      Dim _lstReturn As New List(Of clsHSToHostCommand)
