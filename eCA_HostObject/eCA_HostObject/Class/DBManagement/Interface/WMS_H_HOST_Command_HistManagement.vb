...
Public Class WMS_H_HOST_Command_HistManagement
  Public Shared TableName As String = "WMS_H_HOST_Command_Hist"
  ...
  Enum IdxColumnName As Integer
    ...
    HIST_TIME
  End Enum
  Public Shared Function GetInsertSQL(ByRef Info As clsToHostCommandHist) As String
    Try
