...
Public Class MCS_H_Command_HistManagement
  Public Shared TableName As String = "MCS_H_Command_Hist"
  ...
  Enum IdxColumnName As Integer
    ...
    HIST_TIME
  End Enum
  Public Shared Function GetInsertSQL(ByRef Info As clsFromMCSCommandHist) As String
    Try
