...
Partial Class HOST_T_COMMAND_REPORTManagement
  Public Shared TableName As String = "HOST_T_COMMAND_REPORT"
  ...
  '- GetSQL
  Public Shared Function GetInsertSQL(ByRef Info As clsHOST_T_COMMAND_REPORT) As String
    Try
    ...
    End Try
  End Function
  Public Shared Function GetDeleteSQL(ByRef Info As clsHOST_T_COMMAND_REPORT) As String
    Try
      Dim strSQL As String = ""
    ...
    End Try
  End Function
  Public Shared Function GetHOST_T_COMMAND_REPORTDataListByALL() As List(Of clsHOST_T_COMMAND_REPORT)
    Try
      Dim _lstReturn As New List(Of clsHOST_T_COMMAND_REPORT)
      If DBTool IsNot Nothing Then
        ...
        If DatasetMessage.Tables.Item(0).Rows.Count > 0 Then
          For RowIndex = 0 To DatasetMessage.Tables.Item(0).Rows.Count - 1
            Dim Info As clsHOST_T_COMMAND_REPORT = Nothing
    ...
    End Try
  End Function
  Private Shared Function SetInfoFromDB(ByRef Info As clsHOST_T_COMMAND_REPORT, ByRef RowData As DataRow) As Boolean
    Try
      If RowData IsNot Nothing Then
        ...
        Info = New clsHOST_T_COMMAND_REPORT(UUID, REPORT_SYSTEM_TYPE, REPORT_SYSTEM_UUID, CREATE_TIME)
      End If
      Return True
    Catch ex As Exception
      SendMessageToLog(ex.ToString(), eCALogTool.ILogTool.enuTrcLevel.lvError)
