Public Class clsWMS_CT_ACCOUNT_REPORT
    Private ShareName As String = "WMS_CT_ACCOUNT_REPORT"
    ...
    Public Sub New(ByVal SKU_NO As String, ByVal LOT_NO As String, ByVal ITEM_COMMON1 As String, ByVal ITEM_COMMON2 As String, ByVal ITEM_COMMON3 As String,
               ...
               ByVal WMS_STOCK_QTY As Double, ByVal ERP_SYSTEM As String, ByVal ERP_STOCK_QTY As Double, ByVal QUANTITY_VARIANCE As Double,
               ByVal CREATE_TIME As String, ByVal ACC_COMMON1 As String, ByVal ACC_COMMON2 As String, ByVal ACC_COMMON3 As String,
               ByVal ACC_COMMON4 As String, ByVal ACC_COMMON5 As String)
        MyBase.New()
        Try
            Dim key As String = Get_Combination_Key(SKU_NO, LOT_NO, ITEM_COMMON1, ITEM_COMMON2, ITEM_COMMON3, OWNER_NO, SUB_OWNER_NO)
            _gid = key
            _SKU_NO = SKU_NO
            _LOT_NO = LOT_NO
    ...
    '=================Public Function=======================
    '傳入指定參數取得Key值
    Public Shared Function Get_Combination_Key(ByVal SKU_NO As String, ByVal LOT_NO As String, ByVal ITEM_COMMON1 As String, ByVal ITEM_COMMON2 As String,
                                               ByVal ITEM_COMMON3 As String, ByVal OWNER_NO As String, ByVal SUB_OWNER_NO As String) As String
        Try
            Dim key As String = SKU_NO & LinkKey & LOT_NO & LinkKey & ITEM_COMMON1 & LinkKey & ITEM_COMMON2 & LinkKey & ITEM_COMMON3 & LinkKey & OWNER_NO & LinkKey & SUB_OWNER_NO
            Return key
        Catch ex As Exception
            SendMessageToLog(ex.ToString, eCALogTool.ILogTool.enuTrcLevel.lvError)
            Return ""
        End Try
    End Function
    Public Function Clone() As clsWMS_CT_ACCOUNT_REPORT
        Try
    ...
    Public Function O_Add_Insert_SQLString(ByRef lstSQL As List(Of String)) As Boolean
        Try
            Dim strSQL As String = WMS_CT_ACCOUNT_REPORTManagement.GetInsertSQL(Me)
            lstSQL.Add(strSQL)
            Return True
        Catch ex As Exception
            SendMessageToLog(ex.ToString, eCALogTool.ILogTool.enuTrcLevel.lvError)
    ...
    Public Function O_Add_Update_SQLString(ByRef lstSQL As List(Of String)) As Boolean
        Try
            Dim strSQL As String = WMS_CT_ACCOUNT_REPORTManagement.GetUpdateSQL(Me)
            lstSQL.Add(strSQL)
            Return True
        Catch ex As Exception
            SendMessageToLog(ex.ToString, eCALogTool.ILogTool.enuTrcLevel.lvError)
    ...
    Public Function O_Add_Delete_SQLString(ByRef lstSQL As List(Of String)) As Boolean
        Try
            Dim strSQL As String = WMS_CT_ACCOUNT_REPORTManagement.GetDeleteSQL(Me)
            lstSQL.Add(strSQL)
            Return True
        Catch ex As Exception
            SendMessageToLog(ex.ToString, eCALogTool.ILogTool.enuTrcLevel.lvError)
        ...
        End Try
    End Function
    Public Function Update_To_Memory(ByRef objWMS_CT_ACCOUNT_REPORT As clsWMS_CT_ACCOUNT_REPORT) As Boolean
        Try
            Dim key As String = objWMS_CT_ACCOUNT_REPORT._gid
            If key <> _gid Then
