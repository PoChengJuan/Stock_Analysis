Public Class clsLine_Status
	Private ShareName As String = "Line"
	...
	Private _Status As enuLineStatus
	...
	Public Property Unit_ID() As String
		...
		End Set
	End Property
	Public Property Status() As enuLineStatus
		Get
			Return _Status
		End Get
	...
	Public Property Update_Time() As String
		...
		End Set
	End Property
	Public Property HandlingObject() As clsHandlingObject
		Get
			Return _objHandling
		End Get
	...
	Public Shared Function Get_Combination_Key(ByVal Factory_No As String,
		...
		End Try
	End Function
	Public Function Clone() As clsLine_Status
		Try
	...
	Public Sub Remove_Relationship()
		Try
			If _objHandling IsNot Nothing Then
				_objHandling.O_Remove_Line(Me)
			End If
			If _objLine_Area IsNot Nothing Then
				_objLine_Area.O_Remove_Line(Me)
			End If
		Catch ex As Exception
			SendMessageToLog(ex.ToString, eCALogTool.ILogTool.enuTrcLevel.lvError)
		End Try
	...
	Public Function O_Add_Insert_SQLString(ByRef lstSQL As List(Of String)) As Boolean
		Try
			Dim strSQL As String = WMS_CT_LINE_STATUSManagement.GetInsertSQL(Me)
			lstSQL.Add(strSQL)
			Return True
		Catch ex As Exception
			SendMessageToLog(ex.ToString, eCALogTool.ILogTool.enuTrcLevel.lvError)
	...
	Public Function O_Add_Update_SQLString(ByRef lstSQL As List(Of String)) As Boolean
		Try
			Dim strSQL As String = WMS_CT_LINE_STATUSManagement.GetUpdateSQL(Me)
			lstSQL.Add(strSQL)
			Return True
		Catch ex As Exception
			SendMessageToLog(ex.ToString, eCALogTool.ILogTool.enuTrcLevel.lvError)
	...
	Public Function O_Add_Delete_SQLString(ByRef lstSQL As List(Of String)) As Boolean
		Try
			Dim strSQL As String = WMS_CT_LINE_STATUSManagement.GetDeleteSQL(Me)
			lstSQL.Add(strSQL)
			Return True
		Catch ex As Exception
			SendMessageToLog(ex.ToString, eCALogTool.ILogTool.enuTrcLevel.lvError)
	...
	'非標準的Function
	'=================Public Function=======================
	Public Function Update_To_Memory(ByRef obj As clsLine_Status) As Boolean
		Try
