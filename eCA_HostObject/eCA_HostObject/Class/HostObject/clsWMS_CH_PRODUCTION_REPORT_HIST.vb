Public Class clsWMS_CH_PRODUCTION_REPORT_HIST
Private ShareName As String = "WMS_CH_PRODUCTION_REPORT_HIST"
...
Private _HIST_TIME As String'历史纪录时间
...
Public Shared Function Get_Combination_Key(ByVal FACTORY_NO As  String,ByVal AREA_NO As  String,ByVal PO_ID As  String,ByVal SKU_NO As  String) As String
 ...
 SendMessageToLog(ex.ToString, eCALogTool.ILogTool.enuTrcLevel.lvError)
    ...
    End Try
 End Function
Public Function Clone() As clsWMS_CH_PRODUCTION_REPORT_HIST
 Try
...
Public Function O_Add_Insert_SQLString(ByRef lstSQL As List(Of String)) As Boolean
 Try
Dim strSQL As String = WMS_CH_PRODUCTION_REPORT_HISTManagement.GetInsertSQL(Me)
 lstSQL.Add(strSQL)
 Return True
 Catch ex As Exception
 SendMessageToLog(ex.ToString, eCALogTool.ILogTool.enuTrcLevel.lvError)
...
Public Function O_Add_Update_SQLString(ByRef lstSQL As List(Of String)) As Boolean
 Try
 Dim strSQL As String = WMS_CH_PRODUCTION_REPORT_HISTManagement.GetUpdateSQL(Me)
 lstSQL.Add(strSQL)
 Return True
 Catch ex As Exception
 SendMessageToLog(ex.ToString, eCALogTool.ILogTool.enuTrcLevel.lvError)
...
Public Function O_Add_Delete_SQLString(ByRef lstSQL As List(Of String)) As Boolean
 Try
 Dim strSQL As String = WMS_CH_PRODUCTION_REPORT_HISTManagement.GetDeleteSQL(Me)
 lstSQL.Add(strSQL)
 Return True
 Catch ex As Exception
 SendMessageToLog(ex.ToString, eCALogTool.ILogTool.enuTrcLevel.lvError)
 ...
 End Try
 End Function
Public Function Update_To_Memory(ByRef objWMS_CH_PRODUCTION_REPORT_HIST As  clsWMS_CH_PRODUCTION_REPORT_HIST) As Boolean
Try
Dim key As String = objWMS_CH_PRODUCTION_REPORT_HIST._gid
 If key <> _gid Then
